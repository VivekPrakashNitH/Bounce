    ...
    <div className="w-full max-w-4xl mx-auto bg-slate-900 rounded-xl p-8 border border-slate-700 shadow-2xl relative">
       <div className="flex justify-between items-center border-b border-slate-700 pb-4 mb-8">
          <div className="flex items-center gap-4">
             ...
             <h3 className="text-xl font-mono text-blue-400 flex items-center gap-2">
                <Box /> Level 5: Docker & Containers
             </h3>
          </div>
        ...
        <div className="grid grid-cols-2 gap-8 h-64">
            ...
            {/* Visualizer */}
            <div className="col-span-1 flex flex-col items-center justify-center border-r border-slate-700 pr-8">
                {step === 0 && (
        ...
        <p className="mt-6 text-sm text-slate-400 text-center bg-slate-950/50 p-2 rounded">

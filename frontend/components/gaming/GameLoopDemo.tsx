...
export const GameLoopDemo: React.FC<Props> = ({ onShowCode, onProgress, initialSectionIndex }) => {
    ...
    <div ref={containerRef} className="relative w-full bg-slate-950">
      ...
      {!gateUnlocked && (
        <GateKeeper
          title="Level G02"
          subtitle="Game Loop"
          description="Understand the heartbeat of games: Input → Update → Render → Repeat."

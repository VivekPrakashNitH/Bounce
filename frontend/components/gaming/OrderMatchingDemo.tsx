    ...
    <div className="w-full max-w-4xl mx-auto px-2 sm:px-0 bg-slate-900 rounded-xl p-4 sm:p-8 border border-slate-700 shadow-2xl relative">
       <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3 sm:gap-0 border-b border-slate-700 pb-4 mb-4 sm:mb-8">
          <div className="flex items-center gap-2 sm:gap-4">
             ...
             <h3 className="text-sm sm:text-xl font-mono text-emerald-400 flex items-center gap-2">
                <TrendingUp size={16} /> C++ Project: Order Matching
             </h3>
          </div>
       ...
       <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-8 h-auto sm:h-80">
           ...
           <div className="col-span-1 bg-black border border-slate-700 rounded-lg p-3 sm:p-4 font-mono text-[10px] sm:text-xs flex flex-col relative overflow-hidden min-h-[250px] sm:min-h-0">
           ...
           <div className="col-span-1 flex flex-col justify-center">
               <div className="bg-slate-800 p-3 sm:p-4 rounded-xl border border-slate-700 mb-4 sm:mb-6">
                   <h4 className="text-xs sm:text-sm font-bold text-white mb-2">Your Next Project Idea</h4>
                   <p className="text-[10px] sm:text-xs text-slate-400 leading-relaxed mb-2">
               ...
               <button 
                  ...
                  className={`w-full py-2 sm:py-3 rounded-lg font-bold text-xs sm:text-sm flex items-center justify-center gap-2 transition-colors ${isProcessing ? 'bg-red-600 hover:bg-red-500 text-white' : 'bg-emerald-600 hover:bg-emerald-500 text-white'}`}
               >

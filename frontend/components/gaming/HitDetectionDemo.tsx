...
export const HitDetectionDemo: React.FC<Props> = ({ onShowCode }) => {
  ...
  return (
    <div className="w-full max-w-4xl mx-auto bg-slate-900 rounded-xl p-4 sm:p-8 border border-slate-700 shadow-2xl relative px-2 sm:px-0">
       ...
       <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-8 h-auto sm:h-80">
           
           {/* Game View */}
           <div 
             ref={containerRef}
             className="col-span-1 sm:col-span-2 h-48 sm:h-auto bg-black border border-slate-700 rounded-lg relative overflow-hidden cursor-crosshair"
             onClick={fire}
           >
           ...
           {/* Info Panel */}
           <div className="col-span-1 flex flex-col justify-center space-y-4 sm:space-y-6">

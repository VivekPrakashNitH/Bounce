...
export const GameArchDemo: React.FC<Props> = ({ onShowCode, onProgress, initialSectionIndex }) => {
    ...
    <div ref={containerRef} className="relative w-full bg-slate-950">
      ...
      {!gateUnlocked && (
        <GateKeeper
          ...
          description="Explore how games are structured with rendering, physics, and logic layers."
          difficulty="Beginner"
          theme="nature"

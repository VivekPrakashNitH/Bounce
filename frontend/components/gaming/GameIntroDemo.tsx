    ...
    <div className="w-full max-w-4xl mx-auto px-2 sm:px-0">
      <div className="bg-slate-900 rounded-xl p-3 sm:p-8 border border-slate-700 shadow-2xl relative">
       <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3 sm:gap-0 border-b border-slate-700 pb-4 mb-4 sm:mb-8">
          <div className="flex items-center gap-3 sm:gap-4">
             ...
             <h3 className="text-sm sm:text-xl font-mono text-red-400 flex items-center gap-2">
                <Gamepad2 className="w-4 h-4 sm:w-5 sm:h-5" /> Let's Understand Game Engines
             </h3>
          </div>
       ...
       <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-8 h-auto sm:h-64">
           {/* Visualizer */}
           <div className="col-span-1 bg-black/50 border border-slate-700 rounded-xl p-4 sm:p-6 relative flex flex-col items-center justify-center overflow-hidden min-h-[200px] sm:min-h-0">

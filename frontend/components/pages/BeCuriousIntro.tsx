...
export const BeCuriousIntro: React.FC<Props> = ({ onComplete }) => {
  ...
  const SectionDemo = () => (
    <div className="h-screen w-full bg-black flex flex-col md:flex-row items-center justify-center px-8 md:px-24 gap-12 snap-start relative overflow-hidden">
       {/* Background Gradient */}
       ...
       <motion.div 
          ...
          className="md:w-1/2 h-64 md:h-80 bg-zinc-900 border border-zinc-800 rounded-xl relative shadow-2xl overflow-hidden group"
       >
          {/* Fake Grid */}
  ...
  const SectionGameplay = () => (
    <div className="h-screen w-full bg-zinc-950 flex flex-col md:flex-row-reverse items-center justify-center px-8 md:px-24 gap-12 snap-start border-t border-zinc-900">
       <motion.div 
         initial={{ opacity: 0, x: 50 }}
         whileInView={{ opacity: 1, x: 0 }}
         transition={{ duration: 0.8 }}
       ...
       <motion.div 
          ...
          whileInView={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.8 }}
          className="md:w-1/2 h-64 flex items-end justify-center relative border-b border-zinc-800 pb-12"
       >

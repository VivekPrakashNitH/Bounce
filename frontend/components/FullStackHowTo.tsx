    ...
    <div className="w-full max-w-4xl mx-auto bg-slate-900 rounded-xl p-8 border border-slate-700 shadow-2xl relative">
       <div className="flex justify-between items-center border-b border-slate-700 pb-4 mb-8">
          <div className="flex items-center gap-4">
             ...
             <h3 className="text-xl font-mono text-white flex items-center gap-2">
                <Layout className="text-blue-400" /> How This App Works
             </h3>
          </div>
       ...
       <div className="mt-8 flex flex-col items-center">
           <div className="h-12 text-center mb-4">
               <p className="text-sm font-bold text-white">{steps[step].label}</p>
               <p className="text-xs text-slate-400">{steps[step].desc}</p>
           </div>
           
           <button onClick={advance} className="px-6 py-2 bg-white text-black font-bold rounded-full hover:bg-zinc-200 transition-colors">
               {step === 4 ? 'Reset Flow' : 'Next Step'}
           </button>
           
           <div className="mt-6 p-3 bg-blue-900/20 border border-blue-500/30 rounded text-xs text-blue-200 text-center max-w-lg">

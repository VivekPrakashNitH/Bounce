  ...
  return (
    ...
    <div className="bg-slate-900 rounded-xl p-4 sm:p-8 border border-slate-700 shadow-2xl relative">
       <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3 sm:gap-0 border-b border-slate-700 pb-4 mb-4 sm:mb-8">
          <div className="flex items-center gap-2 sm:gap-4">
             ...
             <h3 className="text-sm sm:text-xl font-mono text-purple-400 flex items-center gap-2">
                <Database className="w-4 h-4 sm:w-5 sm:h-5" /> Consistent Hashing Ring
             </h3>
          </div>
       ...
       <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-8 h-auto sm:h-80">
           ...
           {/* Visualizer */}
           <div className="col-span-1 flex items-center justify-center relative pb-4 sm:pb-0">
               {/* Ring */}
               <div className="w-48 h-48 sm:w-64 sm:h-64 border-4 border-slate-700 rounded-full relative">
           ...
           <div className="col-span-1 flex flex-col justify-center">
               ...
               <div className="flex gap-2 sm:gap-4">
                   <button onClick={addNode} className="flex-1 bg-green-600 hover:bg-green-500 text-white py-1.5 sm:py-2 rounded font-bold text-xs sm:text-sm flex items-center justify-center gap-2">
                       <Plus size={14} className="sm:w-4 sm:h-4" /> Add Node
                   </button>
                   <button onClick={removeNode} className="flex-1 bg-red-600 hover:bg-red-500 text-white py-1.5 sm:py-2 rounded font-bold text-xs sm:text-sm flex items-center justify-center gap-2">
                       <Minus size={14} className="sm:w-4 sm:h-4" /> Remove Node
                   </button>
               </div>

        ...
        >
          <div className="text-center">
            ...
            <div className="md:hidden flex flex-col items-center text-slate-500 mt-4">
              <div className="w-12 h-12 border-2 border-amber-400/50 rounded-full flex items-center justify-center animate-ping opacity-50"></div>
              <span className="text-xs mt-2 text-amber-400">TAP</span>
            </div>
          </div>
        </div>
      )}

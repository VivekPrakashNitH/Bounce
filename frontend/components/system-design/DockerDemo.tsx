    ...
    <div className="bg-slate-900 rounded-xl p-4 sm:p-8 border border-slate-700 shadow-2xl relative">
       <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3 sm:gap-0 border-b border-slate-700 pb-4 mb-4 sm:mb-8">
          <div className="flex items-center gap-2 sm:gap-4">
             ...
             <h3 className="text-sm sm:text-xl font-mono text-blue-400 flex items-center gap-2">
                <Box className="w-4 h-4 sm:w-5 sm:h-5" /> Level 5: Docker & Containers
             </h3>
          </div>
          <div className="flex gap-2">
            ...
            <span className="text-xs text-slate-400 bg-slate-800 px-2 py-1 rounded">Containerization</span>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-8 h-auto sm:h-64">
            ...
            {/* Visualizer */}
            <div className="col-span-1 flex flex-col items-center justify-center border-b sm:border-b-0 sm:border-r border-slate-700 pb-4 sm:pb-0 sm:pr-8">
                {step === 0 && (
                ...
                {step === 1 && (
                    <div className="relative w-32 h-40 bg-slate-800 border-2 border-dashed border-blue-500/50 rounded flex flex-col items-center justify-center animate-pulse">
                ...
                {step >= 2 && (
                    <div className="flex flex-col items-center gap-4">
                        <div className="w-32 h-32 bg-blue-900/20 border-2 border-blue-500 rounded-xl flex items-col justify-center items-center relative shadow-[0_0_20px_rgba(59,130,246,0.3)]">
            ...
            <div className="col-span-1 flex flex-col">
                 <div className="flex-1 bg-black/50 rounded-lg p-3 font-mono text-xs text-slate-300 overflow-y-auto mb-4 custom-scrollbar">
                 ...
                 <div className="flex gap-4">
                     {step === 0 && (
                         <button onClick={handleBuild} className="flex-1 bg-blue-600 hover:bg-blue-500 text-white py-2 rounded font-bold flex items-center justify-center gap-2">
                             <Settings size={16} /> Build Image
                         </button>
                     )}
                     {step === 2 && (
                         <button onClick={handleRun} className="flex-1 bg-green-600 hover:bg-green-500 text-white py-2 rounded font-bold flex items-center justify-center gap-2">
        ...
        <p className="mt-4 sm:mt-6 text-xs sm:text-sm text-slate-400 text-center bg-slate-950/50 p-2 rounded">

...
export const GameLoopDemo: React.FC<Props> = ({ onShowCode }) => {
  ...
  return (
    <div className="w-full max-w-4xl mx-auto bg-slate-900 rounded-xl p-8 border border-slate-700 shadow-2xl relative">
       ...
       <div className="flex items-center justify-between px-12 h-64 relative">
           ...
           {/* Stage: INPUT */}
           <div className={`flex flex-col items-center gap-2 p-4 rounded-xl border-2 transition-all ${activeStage === 'input' ? 'bg-pink-500/20 border-pink-500 scale-110' : 'bg-slate-800 border-slate-700 opacity-50'}`}>
               <Keyboard size={32} className="text-pink-400" />
           ...
           {/* Stage: UPDATE */}
           <div className={`flex flex-col items-center gap-2 p-4 rounded-xl border-2 transition-all ${activeStage === 'update' ? 'bg-blue-500/20 border-blue-500 scale-110' : 'bg-slate-800 border-slate-700 opacity-50'}`}>
           ...
           {/* Stage: RENDER */}
           <div className={`flex flex-col items-center gap-2 p-4 rounded-xl border-2 transition-all ${activeStage === 'render' ? 'bg-green-500/20 border-green-500 scale-110' : 'bg-slate-800 border-slate-700 opacity-50'}`}>

...
export const InstagramDemo: React.FC<Props> = ({ onShowCode }) => {
  ...
  return (
    ...
    <div className="bg-black/40 backdrop-blur-xl rounded-2xl p-3 sm:p-6 border border-white/10 shadow-2xl relative">
       <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3 sm:gap-0 border-b border-white/10 pb-4 mb-4 sm:mb-8">
          <div className="flex items-center gap-2 sm:gap-4">
             ...
             <h3 className="text-sm sm:text-lg font-bold tracking-tight text-white flex items-center gap-2">
                <Camera className="text-pink-500 w-4 h-4 sm:w-5 sm:h-5" /> Case Study: Instagram
             </h3>
          </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-8">
            {/* User Posting */}
            <div className="col-span-1 flex flex-col items-center gap-4 border-b sm:border-b-0 sm:border-r border-white/5 pb-4 sm:pb-0 sm:pr-8 relative">
            ...
            {/* Backend Logic */}
            <div className="col-span-1 flex flex-col items-center justify-center gap-3 sm:gap-6 relative py-4 sm:py-0">
                 {/* Animation Path */}
                 {isPosting && (
                     <>
            ...
            {/* Followers Feeds */}
            <div className="col-span-1 flex flex-col gap-4 border-t sm:border-t-0 sm:border-l border-white/5 pt-4 sm:pt-0 sm:pl-8">

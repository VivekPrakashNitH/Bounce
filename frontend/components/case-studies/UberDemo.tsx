...
export const UberDemo: React.FC<Props> = ({ onShowCode }) => {
  ...
  return (
    <div className="w-full max-w-4xl mx-auto px-2 sm:px-0 bg-black/40 backdrop-blur-xl rounded-2xl p-3 sm:p-6 border border-white/10 shadow-2xl relative">
       <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3 sm:gap-0 border-b border-white/10 pb-4 mb-4 sm:mb-8">
          <div className="flex items-center gap-2 sm:gap-4">
             ...
             <h3 className="text-sm sm:text-lg font-bold tracking-tight text-white flex items-center gap-2">
                <Car className="text-white" size={16} /> Case Study: Uber
             </h3>
          </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-8 h-auto sm:h-80">
            ...
            {/* Controls */}
            <div className="col-span-1 flex flex-col justify-center gap-3 sm:gap-6 relative">
                ...
                <div className="bg-zinc-900 border border-zinc-800 p-3 sm:p-4 rounded-xl">
                    <div className="flex items-center gap-2 sm:gap-3 mb-3 sm:mb-4">
                        ...
                        <div>
                             <div className="text-[10px] sm:text-xs text-zinc-400">Pickup Location</div>
                             <div className="text-xs sm:text-sm font-bold text-white">123 System Design St.</div>
                        </div>
                    </div>
                    <button 
                       onClick={handleRequestRide}
                       disabled={isSearching}
                       className="w-full bg-white hover:bg-zinc-200 text-black font-bold py-2 sm:py-3 text-sm sm:text-base rounded-lg transition-all active:scale-95 disabled:opacity-50"
                    >

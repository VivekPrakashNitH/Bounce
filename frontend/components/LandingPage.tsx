    ...
    <div className="min-h-screen w-full bg-black text-white flex flex-col items-center justify-center relative overflow-hidden">
      ...
      <div className="z-10 text-center mb-8 space-y-4 max-w-2xl px-4 animate-in fade-in slide-in-from-bottom-10 duration-1000 mt-10">
        ...
        <div className="flex flex-col items-center justify-center gap-2 pb-4">
             ...
             <div className="mt-1 px-3 py-1 bg-white/5 rounded-full border border-white/10 flex items-center gap-2">
                 <Bot size={10} className="text-green-400" />
                 <span className="text-[10px] text-zinc-400 font-bold tracking-wider">POWERED BY PUTER.AI</span>
             </div>
        </div>
      </div>
      ...
      <div className="z-10 grid grid-cols-1 md:grid-cols-2 gap-6 w-full max-w-5xl px-8 mb-12">
        ...
        <div className="group relative bg-zinc-900/50 border border-zinc-800 hover:border-blue-500/50 rounded-2xl p-6 backdrop-blur-md transition-all hover:-translate-y-2 hover:shadow-[0_0_30px_rgba(59,130,246,0.2)] cursor-pointer" onClick={onStartGame}>
            <div className="absolute top-4 right-4 text-blue-500 opacity-20 group-hover:opacity-100 transition-opacity">
                {getProgress(['Fundamentals', 'Data', 'Communication', 'DevOps']) > 0 ? <RotateCcw size={20} /> : <Play size={20} />}
            </div>
        ...
        <div className="group relative bg-zinc-900/50 border border-zinc-800 hover:border-purple-500/50 rounded-2xl p-6 backdrop-blur-md transition-all hover:-translate-y-2 hover:shadow-[0_0_30px_rgba(168,85,247,0.2)] cursor-pointer" onClick={onStartCyber}>
        ...
        {/* Track 4: LLD */}
        <div className="group relative bg-zinc-900/50 border border-zinc-800 hover:border-green-500/50 rounded-2xl p-6 backdrop-blur-md transition-all hover:-translate-y-2 hover:shadow-[0_0_30px_rgba(34,197,94,0.2)] cursor-pointer" onClick={onStartLLD}>
